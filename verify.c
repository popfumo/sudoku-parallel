...
bool verify_row(unsigned char **board, unsigned char row, unsigned char column, unsigned char value, unsigned char sidelength) {
...
bool verify_column(unsigned char **board, unsigned char row, unsigned char column, unsigned char value, unsigned char sidelength) {
    for(int i = 0; i < sidelength; i++) {
        if(i == row) {
            continue;
        }
...
bool verify_square(unsigned char **board, unsigned char row, unsigned char column, unsigned char value, unsigned char base) {
